...
class GS_Tutorial1(RoboPy.GameState):
	def __init__(self, kernel, gsm):
		RoboPy.GameState.__init__(self, "Tutorial1", kernel, gsm)
	...
	def Initialize(self):
		self.mTutorialText = pygame.image.load(os.path.join("Data", "tutorialText1.bmp")).convert()
