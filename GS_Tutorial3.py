...
class GS_Tutorial3(RoboPy.GameState):
	def __init__(self, kernel, gsm):
		RoboPy.GameState.__init__(self, "Tutorial3", kernel, gsm)
	...
	def Initialize(self):
		self.mTutorialText = pygame.image.load(os.path.join("Data", "tutorialText3.bmp")).convert()
